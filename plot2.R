...
#load as source file then enter command "createPlot2()"
...
createPlot2 <- function() {
    ...
    mySubTable$TS<- as.POSIXct(paste(mySubTable$Date,mySubTable$Time), 
                               format="%d/%m/%Y %H:%M:%S")
    
    #------start of plot2-----------
    
    plot(x=mySubTable$TS, y=mySubTable$Global_active_power, type = "l", xlab = " ", 
         ylab = "Global Active Power (kilowatts)")
    
    
    #=------end Plot 2 on screen, create plot2.PNG 
